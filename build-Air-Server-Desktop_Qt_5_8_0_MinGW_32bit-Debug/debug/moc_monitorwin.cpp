...
#include "../../../../../Air-Server/Air-Server/monitorwin.h"
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "MonitorWin\0on_pushButton_clicked\0"
};
...
const QMetaObject MonitorWin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MonitorWin.data,
      qt_meta_data_MonitorWin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MonitorWin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MonitorWin.stringdata0))
        return static_cast<void*>(const_cast< MonitorWin*>(this));
